...
notify-send "Volume" -h int:value:$volume -h string:x-dunst-stack-tag:volume -i audio-volume-high-symbolic -t 2000
#+end_src
#+end_src
...
udiskie -a -t &
#+end_src
er-args:bash: :tangle (concat (getenv "XDG_CONFIG_HOME") "/zsh/.zshrc")
:END:
#+begin_src bash
